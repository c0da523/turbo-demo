  ...
  return (
    <Dialog open={open} setOpen={setOpen}>
      <div className="relative mb-10">
        <span className="text-2xl font-medium mr-4 text-white">
          Connect your wallet
        </span>
      ...
      <div className="overflow-hidden">
        <div className="text-white text-xs mb-4">Popular</div>
        ...
        <div className="flex gap-5 mb-8">
          ...
          {connectors.map((connector) => (
            <button
              className="py-2 px-3 bg-green-400 mx-3 rounded hover:bg-green-600"
              key={connector.id}
        ...
        <div className="text-white text-xs mb-4">Others wallets</div>
